...
function ozeki_corporate_render_guide(): void {
    ...
    <div class="wrap">
        ...
        <div class="card">
            ...
            <p><?php esc_html_e('In the Site Editor, open Styles to choose the default look or Japanese Refined. This changes presentation, not language. Select an Image block and choose Soft Shadow, or select a Group block and choose Key Point, when content needs quiet emphasis. These optional block styles do not change the content itself. The homepage news section displays your posts. Review the initial sample post and page yourself; keep, replace or remove them as appropriate. If you do not need news, remove that section from the Front Page template, not your posts.', 'ozeki-corporate'); ?></p>
        </div>
        <div class="card">
